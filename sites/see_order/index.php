                                ...
                                <div class="row">
                                    <div class="neworderleft col-md-6">
                                        <div id="address" class="row">
                                            <div class="col-md-4"><p class="addressLabel">Ulica: </p><input disabled id="street" value="'.$adr[0].'"></div>
                                            <div class="col-md-4"><p class="addressLabel">Nr Domu: </p><input disabled id="house" value="'.$flat[0].'"></div>
                                            <div class="col-md-4"><p class="addressLabel">Nr Mieszkania: </p><input disabled id="flat" value="'.$flat[1].'"></div>
                                        </div>

                                        <div class="row">
                                            <div class="col-md-6"><p class="addressLabel">Imię: </p><input disabled value="'.$name.'"></div>
                                            <div class="col-md-6"><p class="addressLabel">Nazwisko: </p><input disabled value="'.$lName.'"></div>
                                        </div>
                                    </div>
                                    <div class="neworderright col-md-6" style="text-align: center;">
                                        <div id="telephone" class="row">
                                            <div class="col-md-12"><p class="addressLabel">Data telefonu: </p>
                                                <input type="text" disabled id="teldate" value="'.$teldate[0].'"> @ <input type="text" disabled id="teltime" value="'.$teldate[1].'">
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-md-12"><p class="addressLabel">Data odbioru sprzętu:</p>
                                                <input type="text" disabled id="recdate" value="'.$recdate[0].'"> @ <input type="text" disabled id="rectime" value="'.$recdate[1].'">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="neworderright col-md-12">
                                    <div id="telephone" class="row">
                                        <div class="col-md-6"><p class="addressLabel">Data zapytania: </p>
                                            <input type="text" disabled value="'.$teldate[0].'"> @ <input type="text" disabled value="'.$teldate[1].'">
                                        </div>
                                    </div>

                                    <div class="row">
                                        <div class="col-md-12"><p class="addressLabel">Zapytanie: </p>
                                            <textarea disabled>'.$row["orderDescription"].'</textarea>
                                        </div>
                                    </div>

                                    <div class="row">
                                        <div class="col-md-12"><p class="addressLabel">Komentarz ukryty: </p>
                                            <textarea id="hiddenComment" disabled>'.$row["hiddenComment"].'</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                echo '
                    <div class="row">
                            <div class="neworderleft col-md-12">
                                <div id="address" class="row">
                                    <div class="col-md-4"><p class="addressLabel">Marka: </p><input disabled id="hardBrand" value="'.$row["hardBrand"].'"></div>
                                    <div class="col-md-4"><p class="addressLabel">Model: </p><input disabled id="hardModel" value="'.$row["hardModel"].'"></div>
                                    <div class="col-md-4"><p class="addressLabel">SIN: </p><input disabled id="hardSN" value="'.$row["hardSN"].'"></div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6"><p class="addressLabel">Uwagi: </p>
                                        <textarea id="hardWarning" disabled>'.$row["hardWarning"].'</textarea>
                                    </div>
                                    <div class="col-md-6"><p class="addressLabel">Pobrano: </p>
                                        <textarea id="hardDown" disabled>'.$row["hardDown"].'</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            if($hardCount == 0){
                echo '
                    <div class="row">
                            <div class="neworderleft col-md-12">
                                <div id="address" class="row">
                                    <div class="col-md-4"><p class="addressLabel">Marka: </p><input id="hardBrand" disabled></div>
                                    <div class="col-md-4"><p class="addressLabel">Model: </p><input id="hardModel" disabled></div>
                                    <div class="col-md-4"><p class="addressLabel">SIN: </p><input id="hardSN" disabled></div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6"><p class="addressLabel">Uwagi: </p>
                                        <textarea id="hardWarning" disabled></textarea>
                                    </div>
                                    <div class="col-md-6"><p class="addressLabel">Pobrano: </p>
                                        <textarea id="hardDown" disabled></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                while($row6 = $stmt6->fetch()){
                    echo '
                        <div class="col-md-12"><p class="addressLabel">Opis usterki:</p>
                            <textarea id="description" disabled>'.$row6["orderDescription"].'</textarea>
                        </div>
                    ';
                     $orderCount++;
                }
                ...
                echo '
                    <div class="row">
                        <div class="neworderleft col-md-12" style="margin-top: 10px;">
                            ...
                            <textarea id="hiddencomment" disabled>'.$orderHidden.'</textarea>
                        </div>
                    </div>
                    <hr><br>
                ...
                echo '
                    <div class="row">
                        <div class="neworderleft col-md-12" style="margin-top: 10px;">
                            ...
                            <textarea disabled>'.$row['commentText'].'</textarea>
                        </div>
                    </div>
                ';
            }
