            ...
            while($row = $stmt->fetch()){
                ...
                while($row5 = $stmt5->fetch()){
                    ...
                    while($row5 = $stmt5->fetch()){
                        ...
                        $stmt4 = $pdo->prepare('SELECT * FROM orders WHERE orderID = "'.$row5["orderID"].'" AND orderStatus!="Closed"');
                        $stmt4->execute();
                        $countComment = 0;
            ...
            while($row = $stmt->fetch()){
                ...
                while($row5 = $stmt5->fetch()){
                    ...
                    while($row5 = $stmt5->fetch()){
                        ...
                        $stmt4 = $pdo->prepare('SELECT * FROM orders WHERE orderID = "'.$row5["orderID"].'" AND orderType="'.$type.'" AND orderStatus="'.$status.'"');
                        $stmt4->execute();
                        $countComment = 0;
                        while($row4 = $stmt4->fetch()){
                        	$count++;
